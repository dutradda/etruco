...
class Card_Game
{
	public:
		 ...
		 */
		Card_Game(int _num_players, int _num_teams, const string& _xml_file_name );
		 ...
		 */
		int
		load_rules( multimap <int, string>& _rule_errors,
		 ...
		 */
		int apply_rule( const string& _name, vector <void*> _params );
		 ...
		 */		
		Team* get_player_team( Player* _player );
	...
	private:
		 ...
		 */
		int check_rule_dependencies( string _type,
